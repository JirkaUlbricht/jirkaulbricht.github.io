...
<header id="navbar">
    ...
    <div>
        ...
        <div class="narrow-menu group">
            <ul>
                ...
                <li><a href="rezervace.html"><h3 class="rez-current">Rezervace</h3></a></li>
            </ul>
        </div>
    </div>
    <div class="group wide-menu">
        ...
        <a href="rezervace.html"><h3 class="rez-current">Rezervace</h3></a>
    </div>
</header>
                ...
                <li>
                    ...
                    <div>
                        <select id="jizda" name="jizda" required="" aria-label="Zvolte typ návštěvy:">
                            <option selected="" value="Pouze jízda (2500 Kč vč. DPH + 1000Kč/další osoba)">Pouze jízda (2500 Kč vč. DPH + 1000Kč/další osoba)</option>
                            <option value="Jízda a střelba (4000 Kč vč. DPH+ 1000Kč/další osoba)">Jízda a střelba (4000 Kč vč. DPH+ 1000Kč/další osoba)</option>
                        </select>
                    </div>
                </li>
                <li>
